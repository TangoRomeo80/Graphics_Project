...
int TIME=0;
bool START = false;
float clodPosX[7] = {10,-20,30,-40,-20,0,20};
float cloudPosY[7] = {14,15,20,18,17,19,21};
...
void environment(int n){
    ...
    glPushMatrix();
        ...
        glScaled(EN_SIZE*1,0.3,EN_SIZE*10);
        glutSolidCube(1);
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glScaled(EN_SIZE*.01,0.3,EN_SIZE*.3);
        glutSolidCube(1);
    glPopMatrix();
    ...
    glColor3d(1,1,1);
    glPushMatrix();
        glTranslated(clodPosX[n],cloudPosY[n],0);
        glScaled(1,0.3,0.3);
        glutSolidSphere(5,30,30);
    glPopMatrix();

    glPushMatrix();
        glTranslated(clodPosX[n]-4,cloudPosY[n]-1,0);
        glScaled(1,0.3,0.3);
        glutSolidSphere(5,30,30);
    glPopMatrix();
...
static void display(void)
{
    ...
    if(START){
        ...
        drawStrokeText2("Flying Plane",-2,0,0);
    }
...
int main(int argc, char *argv[])
{
    ...
    PlaySound("Top Gun.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
